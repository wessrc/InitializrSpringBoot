...
@Slf4j
@Component
public class MyFactoryBean implements FactoryBean<MyFactoryBean.MyFactoryInnerBean> {

    @Override
    public MyFactoryBean.MyFactoryInnerBean getObject() {
        log.info("=====> [11-1] MyFactoryBean -> getObject()");
        return new MyFactoryBean.MyFactoryInnerBean();
    }

    @Override
    public Class<?> getObjectType() {
        return MyFactoryBean.MyFactoryInnerBean.class;
    }
    ...
    public static class MyFactoryInnerBean{
